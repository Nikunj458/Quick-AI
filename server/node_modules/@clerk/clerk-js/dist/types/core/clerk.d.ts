...
export declare class Clerk implements ClerkInterface {
    ...
    __internal_navigateToTaskIfAvailable: ({ redirectUrlComplete, }?: __internal_NavigateToTaskIfAvailableParams) => Promise<void>;
